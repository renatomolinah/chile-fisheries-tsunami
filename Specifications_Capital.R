...
reg.boat.5 = feols(y_boats ~ post*wave*common | roa + comuna, WDB)

reg.boat.6 = feols(y_boats ~ post*wave*common | roa + month^year, WDB)

reg.boat.7 = feols(y_boats ~ post*wave*common | roa + month^comuna, WDB)

reg.boat.8 = feols(y_boats ~ post*wave*common | roa + year^comuna, WDB)

reg.boat.9 = feols(y_boats ~ post*wave*common | roa + year^month^comuna, WDB)
...
reg.cap.5 = feols(y_cap ~ post*wave*common | roa + comuna, WDB)

reg.cap.6 = feols(y_cap ~ post*wave*common | roa + month^year, WDB)

reg.cap.7 = feols(y_cap ~ post*wave*common | roa + month^comuna, WDB)

reg.cap.8 = feols(y_cap ~ post*wave*common | roa + year^comuna, WDB)

reg.cap.9 = feols(y_cap ~ post*wave*common | roa + year^month^comuna, WDB)
...
reg.power.5 = feols(y_power ~ post*wave*common | roa + comuna, WDB)

reg.power.6 = feols(y_power ~ post*wave*common | roa + month^year, WDB)

reg.power.7 = feols(y_power ~ post*wave*common | roa + month^comuna, WDB)

reg.power.8 = feols(y_power ~ post*wave*common | roa + year^comuna, WDB)

reg.power.9 = feols(y_power ~ post*wave*common | roa + year^month^comuna, WDB)
